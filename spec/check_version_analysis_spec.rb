  ...
  let(:expected_results) do
    {
      ...
      actionmailbox: LibraryVersionAnalysis::Versionline.new(owner: :transitive_unspecified, current_version: nil, current_version_date: nil, latest_version: nil, latest_version_date: nil, releases_behind: nil, major: 4, minor: 0, patch: 0, age: nil),
